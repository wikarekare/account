# Graph Host Histogram. Will be shifting this to in page javascript, with rpc calls
class Graph_Host_Hist < Graph_Parent
  ...
  def gen_gnu_plot_datafile
    ...
    sp.reverse.each do |k, v|
      count += 1
      break if count == 50 # just plot top 50 hosts

      @key_by_index << k       # host ip addresses.
